    ...
    <main style={{ fontFamily: 'sans-serif', padding: '2rem' }}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div style={{ marginBottom: '1rem' }}>
          ...
          <input id="nome" type="text" className='bg-white rounded-xl' value={nome} onChange={(e) => setNome(e.target.value)} required style={{ width: '100%', padding: '8px', marginTop: '4px' }} />
        </div>
        <div style={{ marginBottom: '1rem' }}>
          <label htmlFor="data">Data</label>
          <input id="data" type="date" className='bg-white rounded-xl' value={data} onChange={(e) => setData(e.target.value)} required style={{ width: '100%', padding: '8px', marginTop: '4px' }} />
        </div>
        <div style={{ marginBottom: '1rem' }}>
          <label htmlFor="local">Local</label>
          <input id="local" type="text" className='bg-white rounded-xl' value={local} onChange={(e) => setLocal(e.target.value)} required style={{ width: '100%', padding: '8px', marginTop: '4px' }} />
        </div>
        {error && <p style={{ color: 'red' }}>{error}</p>}
        <div style={{ display: 'flex', gap: '1rem' }}>
          <button type="submit" className='bg-green-500 rounded-xl' style={{ padding: '10px 20px' }}>Salvar Alterações</button>
